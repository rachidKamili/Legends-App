...
public class LegendsFactory {
    ...
    public static Map<LegendGroup, List<Legend>> createLegends(){
        ...
        tankList.add( new Legend("Sion", 0, "THE UNDEAD JUGGERNAUT",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/6/64/Sion_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/2/2c/Sion.start03.ogg"));
        tankList.add( new Legend("Alistar", 1, "THE MINOTAUR",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/5/54/Alistar_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/1/13/Alistar.attack4.ogg"));
        tankList.add( new Legend("Blitzcrank", 1, "THE GREAT STEAM GOLEM",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/d/dc/Blitzcrank_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/b/b8/BlitzcrankLancerRogue_01.ogg"));
        tankList.add( new Legend("Leona", 2, "THE RADIANT DAWN",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/3/3e/Leona_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/e/e5/Leona.attack3.ogg"));
        ...
        fighterList.add( new Legend( "Darius", 0, "THE HAND OF NOXUS",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/1/18/Darius_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/e/e0/Darius.attack2.ogg"));
        fighterList.add( new Legend( "Gangplank", 0, "THE SALTWATER SCOURGE",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/8/80/Gangplank_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/b/b9/Gangplank.start03.ogg"));
        fighterList.add( new Legend( "Camille", 1, "THE STEEL SHADOW",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/3/32/Camille_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/a/a4/Camille.start02.ogg"));
        fighterList.add( new Legend( "Lee Sin", 2, "THE BLIND MONK",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/1/1b/Lee_Sin_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/b/b4/Lee_Sin_Select.ogg"));
        ...
        mageList.add( new Legend( "Swain", 0, "THE NOXIAN GRAND GENERAL",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/d/d1/Swain_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/1/18/SwainDragonMaster011.ogg"));
        mageList.add( new Legend( "Karthus", 2, "THE DEATHSINGER",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/c/c9/Karthus_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/3/38/Karthus.attack11.ogg"));
        mageList.add( new Legend( "Brand", 2, "THE BURNING VENGEANCE",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/5/5c/Brand_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/8/8c/Brand.attack6.ogg"));
        ...
        assassinList.add( new Legend( "Kha'Zix", 0, "THE VOIDREAVER",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/a/a2/Kha%27Zix_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/b/b5/Khazix.attack1.ogg"));
        assassinList.add( new Legend( "Zed", 0, "THE MASTER OF SHADOWS",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/b/b4/Zed_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/8/84/Zed.move1.ogg"));
        assassinList.add( new Legend( "Nocturne", 1, "THE ETERNAL NIGHTMARE",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/4/45/Nocturne_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/f/ff/Nocturne.attack6.ogg"));
        assassinList.add( new Legend( "Master Yi", 1, "THE WUJU BLADESMAN",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/0/09/Master_Yi_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/e/ef/MasterYi_Select.ogg"));
        ...
        marksmenList.add( new Legend( "Jinx", 1, "THE LOOSE CANNON",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/2/21/Jinx_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/1/1b/Jinx.attack06.ogg"));
        marksmenList.add( new Legend( "Twitch", 1, "THE PLAGUE RAT",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/9/9a/Twitch_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/f/fd/Twitch.attack20.ogg"));
        marksmenList.add( new Legend( "Ashe", 2, "THE FROST ARCHER",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/c/c0/Ashe_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/6/60/Ashe.attack05.ogg"));
        marksmenList.add( new Legend( "Varus", 2, "THE ARROW OF RETRIBUTION",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/1/16/Varus_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/e/e2/Varus.attack3.ogg"));
        ...
        supportList.add( new Legend( "Janna", 0,"THE STORM'S FURY",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/c/c9/Janna_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/4/47/Janna.attack5.ogg"));
        supportList.add( new Legend( "Thresh", 2,"THE CHAIN WARDEN",
            ...
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/f/f3/Thresh_OriginalSkin.jpg",
            "http://vignette.wikia.nocookie.net/leagueoflegends/images/a/a0/Thresh.attack3.ogg"));
